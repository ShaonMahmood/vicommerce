...
from oscar.apps.partner.abstract_models import (
    AbstractPartner, AbstractStockAlert, AbstractStockRecord,AbstractProviderModel)
...
if not is_model_registered('partner', 'ProviderModel'):
    class ProviderModel(AbstractProviderModel):
        pass

    __all__.append('ProviderModel')
